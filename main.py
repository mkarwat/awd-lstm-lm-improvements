...
eval_batch_size = 10
test_batch_size = 1
train_data = batchify(corpus.train, args.batch_size, args, device=device)
val_data = batchify(corpus.valid, eval_batch_size, args, device=device)
test_data = batchify(corpus.test, test_batch_size, args, device=device)
...
model = model.RNNModel(args.model, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout, args.dropouth,
                       args.dropouti, args.dropoute, args.wdrop, args.tied, wdropdevice=device)
###
if args.resume:
